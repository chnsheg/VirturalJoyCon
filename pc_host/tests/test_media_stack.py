...
class MediaStackTests(unittest.TestCase):
    ...
    def test_scripts_and_docs_include_streaming_runtime_conventions(self) -> None:
        ...
        self.assertIn('Remove-FirewallRule -Name "JoyCon-WebRTC-Control-UDP-Dynamic"', firewall_text)
        ...
        self.assertIn("JoyCon-WebRTC-Control-UDP-Dynamic", launcher_text)
        self.assertNotIn('"JoyCon-WebRTC-Control-UDP-Dynamic"', launcher_text.split("function Get-MissingFirewallRules", 1)[1].split("function Get-StaleFirewallRules", 1)[0])
