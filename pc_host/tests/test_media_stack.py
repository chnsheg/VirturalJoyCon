...
class MediaStackTests(unittest.TestCase):
    ...
    def test_mediamtx_config_declares_expected_stream_path_and_ports(self) -> None:
        ...
        self.assertNotIn("  - astral", config_text)
        self.assertIn("webrtcAdditionalHosts: []", config_text)
        self.assertNotIn("10.0.0.7", config_text)
        self.assertNotIn("192.168.129.24", config_text)
        self.assertNotIn("169.254.", config_text)
        self.assertNotIn("172.25.", config_text)
    ...
    def test_scripts_and_docs_include_streaming_runtime_conventions(self) -> None:
        ...
        self.assertIn("Use the WLAN address", readme_text)
        self.assertIn("wrong WebRTC candidate", readme_text)
