...
class MediaStackTests(unittest.TestCase):
    ...
    def test_scripts_and_docs_include_streaming_runtime_conventions(self) -> None:
        ...
        self.assertNotIn("FrontendPort", firewall_text)
        self.assertNotIn("WebRtcControlProgram", firewall_text)
        self.assertNotIn("JoyCon-WebRTC-Control-UDP", firewall_text)
        self.assertNotIn("49152-65535", firewall_text)
        ...
        self.assertNotIn("EnableWebRtcMedia", firewall_text)
        ...
        self.assertIn("JoyCon-Web-$GatewayPort", launcher_text)
        self.assertIn("JoyCon-Web-$FrontendPort", launcher_text)
        self.assertIn("JoyCon-MediaMTX-WebRTC-8889", launcher_text)
